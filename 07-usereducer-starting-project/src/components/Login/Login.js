...
const Login = (props) => {
  ...
  const [emailCheck, dispatchEmail] = useReducer(emailReducer, {value: '', isValid: null});

  const [passwordCheck, dispatchpassword] = useReducer(passwordReducer, {value: '', isValid: null});
